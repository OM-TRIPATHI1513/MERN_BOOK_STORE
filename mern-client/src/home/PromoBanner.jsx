...
import bookPic from "../assets/3.png"
import {
    Link
        ...
        <div className='mt-16 py-12 bg-teal-100 px-4 lg:px-24'>
            <div className='flex flex-col md:flex-row justify-between items-center gap-12'>
                <div className='md:w-1/2'>
                    <h2 className='text-4xl font-bold leading-snug'>2023 National Book Awards for Fiction Shortlist</h2>
                ...
                <div>
                      <img src={bookPic} alt='img' className='w-96'/>
                </div>
            </div>
        </div>
    )
